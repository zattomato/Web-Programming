...
<body>
    <body class="text-white" style="background-color: black;">
        ...
        <section id="#home" class="bg-cover hero-section border-bottom pb-0 "
            style="background-image: url('https://images.unsplash.com/photo-1650509220322-40caf79619d7?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80'); background-repeat: no-repeat; background-attachment: fixed; background-size: cover;">
        
        <form class="row container bg-dark " style="margin: 20vh 10px ; z-index: 2; border-radius: 15px; padding: 15px;">
            <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <input type="password" class="form-control" id="nmae" placeholder="Your Name">
            </div>
            <div class="col-12">
            ...
            <div class="col-6">
                ...
                <input type="text" class="form-control" id="IC" placeholder="xxxxxx-xx-xxxx">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-mb-6">
                ...
                <input class="form-control" type="file" id="Vaccine">
            </div>
